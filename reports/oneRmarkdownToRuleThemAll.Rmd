...
catTable <- pin_get("chrisbeeley/newCategories_test", board = "SPACED") %>% 
  set_names(c("Super", "Number", "Category")) %>% 
  mutate(type = "both")

if(!exists("trustData")){
  
  trustData <- pin_get("trustData_test", board = "SPACED")
  questionFrame <- pin_get("questionFrame_test", board = "SPACED")
}
