...
if(params$comment_summary == "textSummary"){
  ...
  if(is.null(improve_1)){
    ...
    cat("Insufficient dat for this type of summary. Please rerun report and select \"verbatim comments\"")
  } else {
    ...
    cat("The most common comment category was ", paste0(improve_1$Super, ": ", improve_1$Category, paste0(improve_1$percent, "%. ")),
        "Example comments include: ", returnTopComments(1, "Improve")[["return_comments"]])
    
    cat("The second most common comment category was ", paste0(improve_2$Super, ": ", improve_2$Category, paste0(improve_2$percent, "%. ")),
        "Example comments include: ", returnTopComments(2, "Improve")[["return_comments"]])
    
    cat("The third most common comment category was ", paste0(improve_3$Super, ": ", improve_3$Category, paste0(improve_3$percent, "%. ")),
  ...
  if(is.null(best_1)){
    ...
    cat("The most common comment category was ", paste0(best_1$Super, ": ", best_1$Category, paste0(best_1$percent, "%. ")),
        "Example comments include: ", returnTopComments(1, "Best")[["return_comments"]])
    
    cat("The second most common comment category was ", paste0(best_2$Super, ": ", best_2$Category, paste0(best_2$percent, "%. ")),
        "Example comments include: ", returnTopComments(2, "Best")[["return_comments"]])
    
    cat("The third most common comment category was ", paste0(best_3$Super, ": ", best_3$Category, paste0(best_3$percent, "%. ")),
