...
This report summarises data from `r params$date_from` to `r params$date_to`
...
if(is.null(report_information)){
  ...
  myString = paste0("<p>Within ", params$area_name, " in the selected time there were ", report_information[["NR"]],
                    " responses.</p><br>",
                    "<p>There were ", report_information[["IC"]], " 'What could we do better' responses and ",
                    report_information[["BC"]], " 'What did we do well' responses</p><br>",
...
trend_function(report_list[["two_year_data"]])
